...
def get_args():
    ...
    #Decensor settings
    parser.add_argument('--mask', default="rgb-0,255,0", help='red channel of mask color in decensoring')
    ...
    #Other settings
    parser.add_argument('--ui-mode',action='store_true', help='true if you want ui mode, false if you want command line interface')
